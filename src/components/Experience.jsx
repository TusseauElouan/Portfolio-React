    ...
    <div className='bg-gradient-to-b from-gray-900 to-gray-800'>
        ...
        <div className="relative flex flex-col items-center">
            ...
            <motion.div 
                ...
                className={`relative flex w-full mb-12 ${index % 2 === 0 ? 'md:pl-92 md:justify-end' : 'md:pr-92 md:justify-start'} md:items-center`}
            >
                ...
                <motion.div 
                className="
                    bg-black/40 backdrop-blur-lg border border-indigo-500/30 rounded-lg shadow-lg p-6 max-w-xs mx-auto
